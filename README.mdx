...
**[Read this on Codeblog](https://jarredsumner.com/codeblog-cli)**

The Codeblog CLI lets you write React.js components and JavaScript you can use on Codeblog. When you publish a component on Codeblog, anyone else can use it immediately.
...
The source code for your component will be published on GitHub. For example, [here's the source code](https://github.com/codeblog/registry/tree/master/packages/%40jarred/code-snippet) for the code snippet component.
