(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("codeblog-render-recipe", ["react"], factory);
	else if(typeof exports === 'object')
		exports["codeblog-render-recipe"] = factory(require("react"));
	else
		root["codeblog-render-recipe"] = factory(root["react"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE__14__) {
...
})(this, function (_exports, _Recipe) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  Object.defineProperty(_exports, "Recipe", {
    enumerable: true,
    get: function get() {
      return _Recipe.Recipe;
    }
  });
  Object.defineProperty(_exports, "transformChildren", {
    enumerable: true,
    get: function get() {
      return _Recipe.transformChildren;
    }
  });
  Object.defineProperty(_exports, "createElementFromRecipe", {
    enumerable: true,
    get: function get() {
      return _Recipe.createElementFromRecipe;
    }
  });
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(3), __webpack_require__(4), __webpack_require__(5), __webpack_require__(6), __webpack_require__(7), __webpack_require__(8), __webpack_require__(9), __webpack_require__(10), __webpack_require__(11), __webpack_require__(12), __webpack_require__(13), __webpack_require__(14), __webpack_require__(15), __webpack_require__(16), __webpack_require__(17)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
  ...
  _exports.Recipe = _exports.recipe2Canvas = _exports.createElementFromRecipe = _exports.transformChildren = void 0;
  ...
  var transformChildren = function transformChildren(children, moduleNames) {
  ...
  _exports.transformChildren = transformChildren;

  var createElementFromRecipe = function createElementFromRecipe(recipe, moduleNames) {
    var componentType = moduleNames.get(recipe.type);

    if (!componentType) {
      throw new Error("Missing component type for recipe: ".concat(recipe.type));
    }

    var _recipe$props = recipe.props,
        _children = _recipe$props.children,
        props = (0, _objectWithoutProperties2.default)(_recipe$props, ["children"]);
    var children = _children ? transformChildren(_children, moduleNames) : [];
    return React.createElement(componentType, props, children);
  };

  _exports.createElementFromRecipe = createElementFromRecipe;

  var recipe2Canvas = function recipe2Canvas(canvasBaseEl) {
  ...
  _exports.recipe2Canvas = recipe2Canvas;
  ...
  function (_React$Component) {
    ...
    function Recipe(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Recipe).call(this, props));
      (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "record",
      /*#__PURE__*/
      function () {
        var _ref = (0, _asyncToGenerator2.default)(
        /*#__PURE__*/
        _regenerator.default.mark(function _callee(seconds, baseEl) {
          var FPS, frames, lastElement, images, video, i, img, encodedVideo;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  lastElement = null;
                  images = [];
                  video = new _Whammy.default.Video(frames);
                  i = 0;
                ...
                case 6:
                  ...
                  _context.next = 9;
                  return recipe2Canvas(baseEl, lastElement);

                case 9:
                  lastElement = _context.sent;
                  img = lastElement.toDataURL("image/webp", 0.8);
                  video.add(img);
                  images.push(img);
      ...
      _this.state = {
        moduleNames: new Map([].concat((0, _toConsumableArray2.default)(Object.entries(props.moduleNames)), (0, _toConsumableArray2.default)(Object.entries(DEFAULT_MODULE_NAMES))))
      };
      return _this;
    }
    ...
    (0, _createClass2.default)(Recipe, [{
      ...
      value: function render() {
        ...
        var moduleNames = this.state.moduleNames;
        var element = createElementFromRecipe(this.props.recipe, moduleNames);
        return element;
      }
    }]);
    return Recipe;
  ...
  _exports.Recipe = Recipe;
  (0, _defineProperty2.default)(Recipe, "defaultProps", {});
});
  ...
  */
  var Whammy = function () {
    ...
    function toWebM(frames, outputAsArray) {
      var info = checkFrames(frames); //max duration by cluster in milliseconds
      ...
      var EBML = [{
        ...
        data: [{
          ...
          id: 0x1c53bb6b,
          // Cues
          data: [//cue insertion point
          ] //cluster insertion point

        }]
      }];
      var segment = EBML[1];
      var cues = segment.data[2]; //Generate clusters (max duration)
    ...
    function generateEBML(json, outputAsArray) {
      ...
      for (var i = 0; i < json.length; i++) {
        ...
        if ((0, _typeof2.default)(data) == "object") data = generateEBML(data, outputAsArray);
        ...
        var size = new Array(zeroes).join("0") + "1" + padded; //i actually dont quite understand what went on up there, so I'm not really
    ...
    function toFlatArray(arr, outBuffer) {
      ...
      for (var i = 0; i < arr.length; i++) {
        if ((0, _typeof2.default)(arr[i]) == "object") {
          //an array
    ...
    function generateEBML_old(json) {
      ...
      for (var i = 0; i < json.length; i++) {
        var data = json[i].data;
        if ((0, _typeof2.default)(data) == "object") data = generateEBML_old(data);
    ...
    function parseWebP(riff) {
      ...
      var width, horizontal_scale, height, vertical_scale, tmp; //the code below is literally copied verbatim from the bitstream spec
    ...
    function doubleToString(num) {
      return [].slice.call(new Uint8Array(new Float64Array([num]).buffer //create a float64 array
    ...
    return {
      ...
      toWebM: toWebM // expose methods of madness
