...
import { camelCase, upperFirst, kebabCase, startCase, trim } from "lodash";
...
const BOILERPLATE_PATH = path.join(root.toString(), "boilerplate");
...
function generateBoilerplate(_name: string, folder: string, username: string) {
