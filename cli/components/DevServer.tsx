...
type State = {
  ...
  components: Array<CodeblogComponent>;
};
...
class RawDevServerComponent extends React.Component<{ cwd: string }, State> {
  ...
  start = async () => {
    this.handleLog("Starting dev server...", LogLevel.debug, "Codeblog");
    ...
    this.handleLog("Started dev server!", LogLevel.info, "Codeblog");

    this.setState({ step: DevServerStep.loading_components });

    process.on("unhandledRejection", console.error);
    const components = await CodeblogComponentStore.loadAll(
      this.props.cwd,
      "dev",
      this.handleLog,
              ...
              {isEditorConnected ? (
                <Box flexDirection="column">
                  <Box flexDirection="row">
                    ...
                    <Box>
                      <Text>
                        {editorURL || "Codeblog Editor is connected."}
                      </Text>
                    </Box>
                  </Box>
                  <Box>
                ...
                <Box flexDirection="column">
                  <Box flexDirection="row">
                    ...
                    <Link url={EDITOR_URL}>
                      <Text>
                        Open Codeblog's editor at https://codeblog.com/write
                      </Text>
                    </Link>
                  </Box>
                </Box>
